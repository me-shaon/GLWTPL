         GLWT (Good Luck With That — Удачи с этим) Общественная Лицензия
                         Copyright (c) Все, кроме Автора

Всем разрешается копировать, распространять, изменять, совмещать, продавать,
публиковать, сублицензировать или делать всё, что угодно, на СВОЙ СТРАХ и РИСК.

                                    Преамбула

Автор не имеет ни малейшего понятия, какую функцию этот код выполняет в
проекте. Он может сработать или не сработать, третьего не дано.


                      "УДАЧИ С ЭТИМ" ОБЩЕСТВЕННАЯ ЛИЦЕНЗИЯ
